...
const TableOfContents = (
	...
	// scrolled past the trigger line just below the sticky MenuBar. Geometry-based
	...
	return (
		<nav
			...
			{...props}
			className={`hidden xl:flex w-56 shrink-0 flex-col gap-3 sticky top-20 self-start max-h-[calc(100vh-7rem)] overflow-y-auto ${className}`}
		>
