...
| onChange  | `(value: string) => void` | n/a     | Called with the full updated string on any change      |
| label     | string                    | n/a     | Visible label above the cells                          |
| error     | string                    | n/a     | Error message; all cells enter the error state         |
| hint      | string                    | n/a     | Helper text shown below the cells                      |
